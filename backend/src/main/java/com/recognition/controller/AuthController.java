...
@CrossOrigin(origins = "https://stockviewdeploy.onrender.com", allowCredentials = "true")
public class AuthController {
    ...
    public void oauth2Success(Authentication authentication, HttpServletResponse response) throws IOException {
        if (authentication == null || !(authentication.getPrincipal() instanceof OAuth2User)) {
            ...
            response.sendRedirect("https://stockviewdeploy.onrender.com/oauth2/redirect?error=NoAuthentication");
            return;
        }
        ...
        // response.sendRedirect("http://localhost:5173/oauth2/redirect?token=" +
        // encodedToken);
        // response.sendRedirect("http://localhost:8080/oauth2/redirect?token=" +
        // encodedToken);
        response.sendRedirect("https://stockviewdeploy.onrender.com/oauth2/redirect?token=" + encodedToken);
    }
